...
<div class="wrap">
	...
	<div class="grids">
		<ul>
			...
			<p>
				<form method="POST">
					<input name="nome" type="text" placeholder="NOME COMPLETO"/> <br><br>
					<input name="cpf" type="text" placeholder="XXXXXXXXXXX - CPF"/> <br><br>
					<input name="email"type="text" placeholder="EMAIL@EMAIL.COM.BR"/> <br><br>
					<input name="tel"type="text" placeholder="DDDXXXXXXXXX - TELEFONE"/> <br><br>
